...
<span className='text-secondary font-cursive text-7xl'>Delivery</span>{" "}
 in Miami</h1>
 <p data-aos = "fade-up" data-aos-delay = "500" className='lg:pr-64'>Delicious Meals Delivered to Your Door from $132.95 per week</p>
 {/* Button Section */}
...
<div data-aos = "zoom-in" data-aos-delay = "500"className='relative z-30 order-1 sm:order-2'>
  <img src= {Hero_img} alt='' className='w-full sm:scale-125 sm::translate-y-16'/>
</div>
</div>
</div>
    </div>
